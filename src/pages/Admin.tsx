...
import { Loader2, Search, User, Mail, Calendar, DollarSign } from "lucide-react";
    ...
    if (filterBy !== "all") {
      switch (filterBy) {
        ...
        case "with_dependents":
          filtered = filtered.filter(user => user.number_of_dependents > 0);
          break;
      }
    }
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div><strong>Marital Status:</strong> {selectedUser.marital_status}</div>
                    <div><strong>Dependents:</strong> {selectedUser.number_of_dependents}</div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div><strong>Monthly Contribution:</strong> {formatCurrency(selectedUser.contribution_amount)}</div>
                    <div><strong>Employer Contribution:</strong> {formatCurrency(selectedUser.employer_contribution)}</div>
                    <div><strong>Retirement Goal Age:</strong> {selectedUser.retirement_age_goal}</div>
                    <div><strong>Risk Tolerance:</strong> {selectedUser.risk_tolerance}</div>
                    <div><strong>Investment Experience:</strong> {selectedUser.investment_experience_level}</div>
                  </div>
                </div>
              </div>
